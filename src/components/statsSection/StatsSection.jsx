            ...
            <div>
                ...
                <div className='flex flex-row flex-wrap justify-around w-[99%] justify-center gap-4'>
                    <div className='border border-light p-[15px] rounded-[10px] w-full md:w-[45%] lg:w-[18%] m-2 flex flex-col'>
                        <img src={ravenImg} className='w-full h-[180px]' alt="raven-music.com image" />
                    ...
                    <div className='border border-light p-[15px] rounded-[10px] w-full md:w-[45%] lg:w-[18%] m-2 flex flex-col'>
                        <img src={cinemateImg} className='w-full h-[180px]' alt="cinemate.com image" />
                    ...
                    <div className='border border-light p-[15px] rounded-[10px] w-full md:w-[45%] lg:w-[18%] m-2 flex flex-col'>
                        <img src={portfolioImg} className='w-full h-[180px] pt-2' alt="older portfolio image" />
                    ...
                    <div className='border border-light p-[15px] rounded-[10px] w-full md:w-[45%] lg:w-[18%] m-2 flex flex-col'>
                        <img src={emojiGameImg} className='w-full h-[180px] pt-2' alt="emoji game image" />
                    ...
                    <div className='border border-neutral-800 bg-neutral-900 p-[15px] rounded-[10px] w-full md:w-[45%] lg:w-[18%] m-2 flex flex-col'>
                        <img src={restaurentImg} className='w-full h-[180px] pt-2' alt="restaurent page image" />
