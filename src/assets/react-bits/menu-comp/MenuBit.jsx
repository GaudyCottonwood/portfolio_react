...
export const StaggeredMenu = ({
    position = 'right',
    colors = ['#c5bcad', '#0f0f0f'],
    items = [
        { label: 'Home', ariaLabel: 'Go to home page', href: '#hero' },
        { label: 'About', ariaLabel: 'Learn about me', href: '#about' },
        { label: 'Skills', ariaLabel: 'View my skills', href: '#skills' },
    ...
    return (
        <div
            className={`sm-scope z-40 ${isFixed ? 'fixed w-screen h-screen' : 'absolute w-full h-full'} top-0 left-0 overflow-hidden`}
        >
            <div
                className={
            ...
            >
                ...
                >
                    <div className="font-outfit font-[900] text-3xl text-white">
                        <></>
                    </div>
